        ...
        <section className='body'>
            ...
            <section className='article'>
                ...
                <article>
                    ...
                    I firmly believe that nothing helps teams, leaders, and clients work in sync together better than managing each other's expectations and delivering accordnigly.
                </article>
            </section>
        </section>
    )
